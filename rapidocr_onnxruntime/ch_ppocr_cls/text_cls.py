...
class TextClassifier:
        ...
        for beg_img_no in range(0, img_num, batch_num):
            ...
            for rno, (label, score) in enumerate(cls_result):
                ...
                if "180" in label and score > self.cls_thresh:
                    img_list[indices[beg_img_no + rno]] = np.rot90(
                        img_list[indices[beg_img_no + rno]], k=1
                    )
    ...
    def resize_norm_img(self, img: np.ndarray) -> np.ndarray:
        ...
        resized_image = pil_img.resize((resized_w, img_h), Image.BILINEAR)
